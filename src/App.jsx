          ...
          <>
            ...
            <div className={styles.content}>
              ...
              <div className={styles.addRow}>
                <button className={styles.addBtn} onClick={() => addStop(stops.length - 1)}>
                  + Add stop
                </button>
                <button className={styles.addBtnSecondary} onClick={() => addStop(stops.length)}>
                  + Add at end
                </button>
              </div>
            </div>
